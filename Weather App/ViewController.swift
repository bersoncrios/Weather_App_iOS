...
class ViewController: UIViewController {
    ...
    private func setConstraints(){
        ...
        NSLayoutConstraint.activate([
            nextDaysLabel.topAnchor.constraint(equalTo: hourlyCollectionView.bottomAnchor, constant: 29),
            nextDaysLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 35),
            nextDaysLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -35),
            
            dailyForecastTableView.topAnchor.constraint(equalTo: nextDaysLabel .bottomAnchor, constant: 16 ),
